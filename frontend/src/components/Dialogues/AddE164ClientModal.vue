...
import { generateEmpty as generateEmptyE164Client } from '@/_Composables/GraphQL/E164Client/IE164Client';
	...
	<q-dialog @show="open" @hide="close" v-model="isOpen" persistent>
		<q-card>
			<div class="flex flex-col p-4 gap-1">
				<div class="font-bold">Add Number Client:</div>
				<q-input label="E164:" placeholder="+12045551234" dense v-model="newE164Value" autofocus
					@keyup.enter="save">
				</q-input>
				<div class="text-xs text-grey-8">This is the number that the system will call.</div>
				<div class="flex flex-row justify-end">
					<q-btn flat color="red" label="Cancel" @click="resetAndClose" :loading="isAnyLoading"
