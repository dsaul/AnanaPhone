...
import { useE164 } from '@/_Composables/GraphQL/E164Client/useE164';
import { useComment } from '@/_Composables/GraphQL/E164Client/useComment';
import { useOutboundDevice } from '@/_Composables/GraphQL/E164Client/useOutboundDevice';
import { useDisabled } from '@/_Composables/GraphQL/E164Client/useDisabled';
import MDIDelete from '@/components/SVG/MDIDelete.vue';
import MDIContentSave from '@/components/SVG/MDIContentSave.vue';
import RemoveE164ClientModal from '@/components/Dialogues/RemoveE164ClientModal.vue';
import { useMutationUpsert } from '@/_Composables/GraphQL/E164Client/useMutationUpsert';
...
const editModel = ref<IE164Client | null>(null);
...
<template>
	<q-card>
		<RemoveE164ClientModal ref="removeModalEl" v-model="editModel" />
