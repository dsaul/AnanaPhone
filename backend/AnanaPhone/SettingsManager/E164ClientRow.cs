...
namespace AnanaPhone.SettingsManager
{
	public class E164ClientRow
	{
		...
		[GraphSkip]
		public static E164ClientRow ForDataReader(DbDataReader reader)
		{
			return new()
			{
		...
		[GraphSkip]
		public static IEnumerable<E164ClientRow> GetAll(SQLiteConnection DB)
		{
			if (DB == null)
		...
		[GraphSkip]
		public static IEnumerable<E164ClientRow> ForE164(SQLiteConnection DB, string e164)
		{
			if (DB == null)
				throw new Exception("DB == null");
		...
		[GraphSkip]
		public static int Upsert(SQLiteConnection DB, E164ClientRow number)
		{
			if (DB == null)
				throw new Exception("DB == null");
